...
def home_page(page: str, artifacts: list[Artifact], links: list[Link], site_url: str) -> str:
  ...
  <div class="harness-shell">
    ...
    <div class="harness-main">
      <header class="harness-topline"><div><p class="eyebrow">Private agent session</p><h1>Ask Hermes.</h1></div><div class="session-indicator"><span class="status-dot"></span><span>Session ready</span><code>GLM-5.3 / HERMES</code></div></header>
