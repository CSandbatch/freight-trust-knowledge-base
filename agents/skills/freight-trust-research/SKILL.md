...
1. Read `research/GOALS.md`, `research/evidence.md`, `research/review-notes.md`, and the
   relevant section of `RESEARCH_PROGRAMME.md`.
2. Have Terra create task packets in `research/run-log.md`. Split Luna tasks only where
...
Use [references/artifact-contracts.md](references/artifact-contracts.md) for task packets,
evidence entries, and review findings. Use [references/source-policy.md](references/source-policy.md)
