...
The editable Mermaid source files are kept alongside this index. The diagrams below render natively in Obsidian; use the linked `.mmd` file when source reuse outside a note is needed.
