...
One entry per sourced claim, per the schema in [agents/ROSTER.md](../agents/ROSTER.md).
...
Proto-OKN funding total (§G3). Synthesized into `RESEARCH_PROGRAMME.md` — see that
...
**not** itself create or define a duty-of-care standard. `RESEARCH_PROGRAMME.md` should be
...
- **Claim:** Cassandra Gaines — transportation attorney, and (new fact not in prior team
  ...
  also one of the twelve competitors on this programme's landscape list (see G4) — CAVRA
  is not a neutral third-party standard, it's a vendor's proprietary framework being
  positioned as an industry standard. This matters directly for how this programme
  should describe CAVRA in any SBIR narrative. Confidence: secondary.
...
architecture per public claims — this is a real, confirmed differentiator for the OKN
framing, not narrative color. **Only Truckstop.com (via RMIS) spans both fraud/vetting
...
| NMFTA | 2026 Transportation Industry Cybersecurity Trends Report (Dec 2025) — cyber-enabled cargo theft, expanding scope to carriers/shippers/brokers/tech vendors; runs a Cargo Crime Reduction Framework + new SCAC verification initiative. No detention/duty-of-care statement. | primary — [nmfta.org](https://nmfta.org/newsroom-articles/nmfta-releases-2026-transportation-industry-cybersecurity-trends-report/) |

## G7 — Data-sharing incentive precedent — ⚪ not started
