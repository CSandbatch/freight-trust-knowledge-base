...
Sequencing for `03-research-evidence/goals.md`, mapped to the agent roster (`05-agent-system/roster.md`).
Phases 0–1 are underway as of this writing; everything after Phase 1 is blocked on it.

## Phase 0 — Scaffolding (done)

Promote intake findings into the active vault, build agent roster → `05-agent-system/`, consolidate into
`02-programme-strategy/research-programme.md`, formalize goals → `03-research-evidence/goals.md`.
...
Output lands in `03-research-evidence/evidence.md`. Nothing in Phase 2+ should cite these topics
...
**Exit criteria:** `02-programme-strategy/research-programme.md` §3 (stakeholder table) and §5 (competitive
...
- Confirm whether the "destructively consolidate" instinct from earlier (archiving originals,
  one canonical programme doc) matches how the team wants to keep working, now that a
  `03-research-evidence/` working layer exists alongside it.
...
Synthesis Agent rewrites `02-programme-strategy/research-programme.md` §3, §4, §5 from the now-populated
`03-research-evidence/evidence.md`, with named uncertainty preserved for anything still single-sourced.
Produces `03-research-evidence/briefing.md` per the roster's Synthesis Agent contract if the briefing
...
Output: `03-research-evidence/review-notes.md`, tagged open/resolved.
