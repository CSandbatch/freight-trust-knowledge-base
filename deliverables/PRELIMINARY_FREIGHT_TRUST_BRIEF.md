...
[CLIENT_LANDSCAPE_AND_SBIR_READINESS_BRIEF.md](CLIENT_LANDSCAPE_AND_SBIR_READINESS_BRIEF.md).
...
The near-term purpose is not to create a universal carrier score or prescribe a legal duty
of care. It is to test whether evidence provenance, entity resolution, and shared event
semantics improve verification and operational visibility.

## Why now

Driver detention is both economically significant and poorly measured. ATRI's 2023
...
requires trusted repositories, linked records, secure access, and event recording—not
simply a graph database. [NIST IR 8536](https://csrc.nist.gov/pubs/ir/8536/ipd)
...
A “neutral” system needs operational safeguards, not just a neutral label. The Global
Legal Entity Identifier System provides a useful analogue: standardized open entity data,
quality controls, and a challenge/update mechanism under independent governance. It is not
a freight solution, but it illustrates the elements needed for a trusted utility.
...
This brief is derived from the programme's [wide-net evidence synthesis](../research/LUNA_WIDE_NET_SYNTHESIS.md), [research goals](../research/GOALS.md), and [review notes](../research/review-notes.md). The underlying agent and evidence workflow is documented in [the project framework](../agents/FRAMEWORK.md).
